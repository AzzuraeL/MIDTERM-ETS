...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 min-h-screen flex items-center justify-center p-4 transition-colors">
    <div class="w-full max-w-md">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">            <div class="flex justify-between items-center mb-8">
                <h2 class="text-3xl font-bold text-gray-800 dark:text-white">Login</h2>                <button 
            ...
            @if (session('success'))
                <div class="p-4 mb-4 rounded-lg bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-100">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <p class="text-center text-gray-600 dark:text-gray-400 text-sm mt-6">
                Don't have an account? <a href="{{ route('register') }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold">Register here</a>
            </p>
        </div>
    </div>    <script>
